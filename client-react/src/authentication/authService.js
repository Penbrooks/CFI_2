export default {
    ...
    instagramLogin:user=>{
        return fetch('localhost/user/auth/instagram/callback',{
        })
    },
    loginGoogle:(user)=>{
    ...
    update: user=>{
        return fetch('localhost/user/update',{
            method:'put',
            body : JSON.stringify(user),
            headers:{
                'Content-Type':'application/json'
    ...
    delete:user=>{
        return fetch('localhost/user/delete',{
            method:"put",
            body:JSON.stringify(user),
            headers:{
                'Content-Type':'application/json'
    ...
    updateReelsDemos:user=>{
        return fetch('localhost/user/updatereelsanddemos',{
            method:"put",
            body:JSON.stringify(user),
            headers:{
                'Content-Type':'application/json'
